function onLoad() {
  ...
  CV.UI.loadCave("% survey filename %");
}
...
BGSProvider.prototype.getUrl = function(x, y, z) {
  ...
  var url =
    "https://map.bgs.ac.uk/arcgis/services/BGS_Detailed_Geology/MapServer/WMSServer?REQUEST=GetMap&VERSION=1.3.0" +
    this.layers +
